...
process importDb {
	...
	"""
		...
		--input-path /crex/proj/naiss2023-22-866/MetONTIIME/sh_refs_qiime_ver9_dynamic_all_25.07.2023.fasta \
		--output-path ${params.resultsDir}/importDb/${params.dbSequencesQza}

		qiime tools import \
		--type \'FeatureData[Taxonomy]\' \
		--input-path /crex/proj/naiss2023-22-866/MetONTIIME/noheader_taxonomy_qiime_ver9_dynamic_alleukaryotes_25.07.2023.tsv \
...
process importFastq {
	...
	"""
		...
		fq=\$(realpath \$(find $workdir -maxdepth 1 | grep \"\\.fastq\\.gz\"))
